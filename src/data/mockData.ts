...
export const initialSchoolSettings: SchoolSettings = {
  ...
  cardBgColor: 'slate',
  cardBorderColor: 'slate',
  cardPadding: 'normal',
  cardRadius: 'rounded-2xl',
  youtubeVideoUrl: 'https://www.youtube.com/watch?v=dQw4w9WgXcQ',
  youtubeVideoTitle: 'Dokumentasi Kegiatan Belajar & Ekstrakulikuler Unggulan Yayasan Nusantara',
  socialInstagram: 'https://instagram.com/yayasannusantarajaya',
  socialFacebook: 'https://facebook.com/yayasannusantarajaya',
  socialTiktok: 'https://tiktok.com/@yayasannusantara',
  socialWebsite: 'https://yayasan-nusantara.sch.id',
  broadcastNotification: {
    active: true,
    title: '📢 PENGUMUMAN PENTING ADMIN YAYASAN',
    message: 'Jadwal Penilaian Tengah Semester (PTS) TA 2024/2025 akan diselenggarakan minggu depan. Pastikan presensi QR-Code dan administrasi SPP siswa sudah terdata dengan benar.',
    type: 'warning',
    date: '10 Agu 2026',
    id: 'broadcast-1'
  },
